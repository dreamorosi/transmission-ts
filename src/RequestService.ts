...
import type { InvalidSessionRetry } from './types';
import type {
  RequestService as IRequestService,
  RequestServiceConfig,
} from './types/RequestService';
import type { SessionService as ISessionService } from './types/SessionService';
      ...
      const response = await fetch(this.#pathname, {
        ...
        headers: {
          'X-Transmission-Session-Id':
            await this.#sessionService.getSessionId(),
          Authorization: this.#authHeader,
        },
        body,
      });
